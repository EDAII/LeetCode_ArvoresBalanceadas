...
Repositório destinado à resolução de questões relacionadas a algoritmos de manipulação de árvores.
...
O objetivo deste projeto é implementar soluções para problemas de Árvores Binárias disponíveis na plataforma **LeetCode**.  
...
| Questão | Dificuldade |
|----------|--------------|
| [1373. Maximum Sum BST in Binary Tree](https://leetcode.com/problems/maximum-sum-bst-in-binary-tree/description/) | Hard |
...
| [Q17. Delete Node in a BST](https://leetcode.com/problems/delete-node-in-a-bst/description/) | Medium |
